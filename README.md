...
To make the game mobile, I'm going to cut 'n paste a copy of <em>keyListener(event)</em> and call it 
<em>touchListener(event)</em>.

https://eloquentjavascript.net/15_event.html


tend to be <a href="https://developer.mozilla.org/en-US/docs/Web/API/TouchList">Touch Lists</a> of
<a href="https://developer.mozilla.org/en-US/docs/Web/API/Touch">Touch Objects</a> which are similar to
<a href="https://developer.mozilla.org/en-US/docs/Web/API/MouseEvent">Mouse Events</a>.

For some inexplicable reason, the committee responsible for touch events decided to create lots of associated keyboard events.
Cutting out that 90% of crap to keep just the ones that return touch lists leaves us with:




I naively approaches this thinking all I'd need to do is follow the instructions in 
<a href="https://developer.mozilla.org/en-US/docs/Web/API/Touch_events/Using_Touch_Events">Using Touch Events</a>
where I saw one event called 
Using  &mdash;
which I assumed could use the template I'd already created for
<a href="https://developer.mozilla.org/en-US/docs/Web/API/Document/keydown_event">keydown</a> &mdash;
and another called  which I
thought would be similar to <a href="https://developer.mozilla.org/en-US/docs/Web/API/Document/keyup_event">keyup</a>.

Unfortunately, , and it turns out
<a href="https://developer.mozilla.org/en-US/docs/Web/API/Touch_events">Touch Events</a> don't actually add much to 
 which are
easier to test and debug on a non-mobile device.

https://developer.mozilla.org/en-US/docs/Web/API/Pointer_events

I'm going to attach the touch events to the <em>canvas</em> rather than the <em>document</em>, following 
<a href="https://developer.mozilla.org/en-US/docs/Web/API/Touch_events/Using_Touch_Events#Best_practices">Best Practices</a>
tips in Mozzila's guide. To ensure the canvas has been loaded and sized, I'll do this in the DOMContentLoaded pyramid.
...
<a href="https://developer.mozilla.org/en-US/docs/Web/API/Document/touchend_event">touchend</a>, while leaving out
<a href="https://developer.mozilla.org/en-US/docs/Web/API/Document/touchmove_event">touchmove</a> and
<a href="https://developer.mozilla.org/en-US/docs/Web/API/Element/touchcancel_event">touchcancel</a>.
